            ...
            <form action="{{ route('tournaments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                        class="w-full px-4 py-3 rounded-xl border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-200' }} focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
                        required>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full px-4 py-3 rounded-xl border {{ $errors->has('description') ? 'border-red-500' : 'border-gray-200' }} focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none">{{ old('description') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="location_map" rows="2"
                        class="w-full px-4 py-3 rounded-xl border {{ $errors->has('location_map') ? 'border-red-500' : 'border-gray-200' }} focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
                        placeholder="<iframe src='...'>"> {{ old('location_map') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="terms_and_conditions" rows="3"
                        class="w-full px-4 py-3 rounded-xl border {{ $errors->has('terms_and_conditions') ? 'border-red-500' : 'border-gray-200' }} focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none">{{ old('terms_and_conditions') }}</textarea>
                ...
                <button type="submit"
                    class="w-full bg-primary hover:bg-purple-500 text-white font-bold py-4 rounded-xl shadow-md transition transform hover:-translate-y-1">
